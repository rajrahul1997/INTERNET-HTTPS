...
Once the connection is established, both parties can use the agreed algorithm and keys to securely send messages to each other.Handshake takes in 3 main phases. - Hello, Certificate Exchange and Key Exchange.
